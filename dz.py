...
stud1 = Student('Иван', 'Иванова', 'f')
stud2 = Student('Олег', 'Тиньков', 'm')
lec1 = Lecturer('Игорь', 'Акенфеев')
lec2 = Lecturer('Лара', 'Крофт')
rev1 = Reviewer('Милен', 'Формен')
rev2 = Reviewer('Петр', 'Романов')
...
rev2.rate_hw(stud2, 'python', 6)
stud1.rate_lecturer(lec1, 'python', 6)
stud2.rate_lecturer(lec2, 'python', 9)
